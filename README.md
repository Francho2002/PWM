...
Desde una bóveda abierta, elegí **Archivo llave USB** e ingresá la clave maestra actual. Se descargará un pequeño archivo JSON para guardar en tu pendrive. Luego, en la pantalla bloqueada, elegí **Desbloquear con archivo llave** y seleccioná ese archivo manualmente.
